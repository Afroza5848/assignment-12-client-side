        ...
        <div className='w-full px-6 py-8 md:px-8 lg:w-1/2'>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='mt-6'>
              <button
                type='submit'
                className='w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-green-500 login rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50'
              >
          ...
          <div className='flex items-center justify-between mt-4'>
            ...
            <Link
              to='/registration'
              className='text-xs text-gray-500 hover:text-green-500 uppercase  hover:underline'
            >
              or sign up
            </Link>
